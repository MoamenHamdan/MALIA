...
public partial class Reconciliation5e56f08ace6f4af2
{
    ...
    public string? MvtDesc { get; set; }

    public string? MvtType { get; set; }

    public string MvtStatus { get; set; } = null!;

    public string MvtUsName { get; set; } = null!;

    public string? PlDescFrom { get; set; }

    public string UsShortName { get; set; } = null!;

    public string? PlDescTo { get; set; }
}
