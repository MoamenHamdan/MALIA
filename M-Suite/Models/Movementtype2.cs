...
public partial class Movementtype2
{
    ...
    public short MvtQuantityMultiplier { get; set; }
    ...
    public short? MvtHoldQuantity { get; set; }
    ...
    public short? MvtManageLotexprod { get; set; }
    ...
    public short? MvtGenerateDueInvoice { get; set; }
    ...
    public short? MvtReserveQuantity { get; set; }

    public DateTime? MvtPreviewQuantity { get; set; }

    public virtual ICollection<MovementtypeOption> MovementtypeOptions { get; set; } = new List<MovementtypeOption>();

    public virtual Codesc? MvtCdIdModNavigation { get; set; }

    public virtual Codesc? MvtCdIdTptNavigation { get; set; }
}
